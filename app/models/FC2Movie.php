...
class FC2Movie {
	...
	public static function search_by_name($name)
	{
		...
		{
			$html = HtmlDomParser::file_get_html("http://video.fc2.com/a/movie_search.php?ordertype=2&perpage=8&keyword=".urlencode($name));
			...
			}, $html->find('#video_list_1column .clsThumbToAlbum a'));
