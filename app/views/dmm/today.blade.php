...
<div class="row">
	@foreach($girls as $girl)
		<div class="section bg-lightPink">
			<h3 class="bg-white"><a href="/dmm/girl/{{{ $girl->name }}}" class="darklink">ハッピーバースデー！{{{ $girl->name}}}さん<br>{{{ $year - $girl->year }}}歳の誕生日、おめでとうございます。</a></h3>
			...
			<a href="/dmm/girl/{{{ $girl->name }}}" class="bg-white place-right girllink darklink">もっと見る</a>
			</div>
		</div>
		@include('girl.banner')
	@endforeach
